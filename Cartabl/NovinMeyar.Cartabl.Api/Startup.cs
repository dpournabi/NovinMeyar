...
using NovinMeyar.Cartabl.Api.Data;
using NovinMeyar.Cartabl.Api.Helper;
...
namespace NovinMeyar.Cartabl.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            seedData.SeedRequestTypeAsync().Wait();
            seedData.SeedIncpectionTypeAsync().Wait();

            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "NovinMeyar.Cartabl.Api v1"));
            app.UseRouting();
