...
using NovinMeyar.Common.Api.Data;
using NovinMeyar.Common.Api.Helper;
...
namespace NovinMeyar.Common.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "NovinMeyar.Common.Api v1"));
            app.UseRouting();
