...
using NovinMeyar.FileManagment.Api.Services.ver_1._0.Implementation;
using NovinMeyar.Common.CustomAuthorize;
using NovinMeyar.Common;

namespace NovinMeyar.FileManagment.Api.Helper
{
    public class ServiceConfigurations
    {
        ...
        public static void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "NovinMeyar.FileManagment", Version = "v1" });
            });
        }
        ...
        public static void ConfigureDatabase(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<DataContext>(options =>
            {
                ...
                {
                    sqlserverOptions.CommandTimeout(360); // 6 minutes
