...
using NovinMeyar.Customer.Api.Services.ver_1._0.Implementation;
using NovinMeyar.Common.CustomAuthorize;
using NovinMeyar.Common;

namespace NovinMeyar.Customer.Api.Helper
{
    public class ServiceConfigurations
    {
        ...
        public static void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "NovinMeyar.Cusromer.Server", Version = "v1" });
            });
        }
        ...
        {
            services.AddScoped<ILegalCustomerService, LegalCustomerService>();
            services.AddScoped<IRealCustomerService, RealCustomerService>();
        }
        ...
        public static void ConfigureMassTransit(IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                //c.AddConsumer<GetUsersByRole>();
                c.UsingRabbitMq((context, cfg) =>
                {
                    //cfg.ReceiveEndpoint(_appSettings.QueueSetting.QueueName, e =>
                    //{
                    //    e.ConfigureConsumer<GetUsersByRole>(context);
                    //});
